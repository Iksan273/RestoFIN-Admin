                        ...
                        <div class="col-md-4 col-xl-4">
                            <div class="card bg-c-blue order-card">
                                <div class="card-body">
                                    ...
                                    <h2 class="text-start"><span>1641</span><i class="feather icon-star-on float-end"></i>
                                    </h2>
                        ...
                        <div class="col-xl-12 col-md-6">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <select id="year-select" class="form-control" style="width: auto; display: inline-block; margin-left: 20px;">
                        ...
                        <div class="col-xl-12 col-md-6">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <select id="month-select" class="form-control" style="width: auto; display: inline-block; margin-left: 20px;">
...
$(document).ready(function() {
    ...
    $('#year-select').change(function() {
        ...
        var newData = Array.from({length: 12}, () => Math.floor(Math.random() * 100));
...
<script type="text/javascript">
    ...
    const monthlyData = {
        'Jan': [
            ['Day', 'Sales'],
            [1, 200], [2, 800], [3, 210], [4, 250], [5, 300],
            [6, 310], [7, 320], [8, 330], [9, 340], [10, 350],
            [11, 360], [12, 370], [13, 380], [14, 390], [15, 400],
            [16, 410], [17, 420], [18, 430], [19, 440], [20, 450],
            [21, 460], [22, 470], [23, 480], [24, 490], [25, 500],
            [26, 510], [27, 520], [28, 530], [29, 540], [30, 550]
        ],
        // Add similar data for other months
        'Feb': [
            ['Day', 'Sales'],
            [1, 210], [2, 230], [3, 220], [4, 260], [5, 310],
            [6, 320], [7, 330], [8, 340], [9, 350], [10, 360],
            [11, 370], [12, 380], [13, 390], [14, 400], [15, 410],
            [16, 420], [17, 430], [18, 440], [19, 450], [20, 460],
            [21, 470], [22, 480], [23, 490], [24, 500], [25, 510],
            [26, 520], [27, 530], [28, 540], [29, 550], [30, 560]
        ],
