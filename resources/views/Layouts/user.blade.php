                        ...
                        <ul class="pcoded-submenu">
                            ...
                            <li class="pcoded-hasmenu"><a href="#" class="">Menu</a>
                                <ul class="pcoded-submenu">
                                    ...
                                    <li class=""><a href="{{ route('employee.addMenu') }}" class="" >Add Menu</a>
                                    </li>
                                    <li class=""><a href="{{ route('employee.rekomendasi') }}" class="" >List Rekomendasi
                                            Menu</a></li>
                                    <li class=""><a href="{{ route('employee.addRekomendasi') }}" class="">Add Rekomendasi
                                            Menu</a></li>
                                </ul>
                            </li>
                            ...
                            <li class="pcoded-hasmenu"><a href="#!" class="">Struk Pembelian Online</a>
                                <ul class="pcoded-submenu">
                                    <li class=""><a href="{{ route('employee.struk') }}" class="" >List
                                            Pembelian</a></li>
                                    <li class=""><a href="{{ route('employee.addStruk') }}" class="" >Add</a></li>
                                </ul>
                            </li>
                            <li class="pcoded-hasmenu"><a href="#!" class="">Member Point</a>
                                <ul class="pcoded-submenu">
                                    <li class=""><a href="{{ route('employee.pointMinusAdmin') }}" class="" >Mengurangi Point by admin</a></li>
                                    <li class=""><a href="{{ route('employee.pointMinus') }}" class="" >Mengurangi Point dengan promo</a></li>
                                </ul>
                            </li>
